 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toInteger=_dereq_("to-integer-x").toInteger2018,toLength=_dereq_("to-length-x").toLength2018,isUndefined=_dereq_("validate.io-undefined"),splitIfBoxedBug=_dereq_("split-if-boxed-bug-x"),getMax=function _getMax(a,b){return a>=b?a:b},getMin=function _getMin(a,b){return a<=b?a:b},setRelative=function _setRelative(value,length){return value<0?getMax(length+value,0):getMin(value,length)};module.exports=function slice(arrayLike,start,end){var iterable=splitIfBoxedBug(toObject(arrayLike)),length=toLength(iterable.length),k=setRelative(toInteger(start),length),relativeEnd=isUndefined(end)?length:toInteger(end),finalEnd=setRelative(relativeEnd,length),val=[];val.length=getMax(finalEnd-k,0);for(var next=0;k<finalEnd;)k in iterable&&(val[next]=iterable[k]),next+=1,k+=1;return val}},{"split-if-boxed-bug-x":26,"to-integer-x":28,"to-length-x":29,"to-object-x":31,"validate.io-undefined":38}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var boxedString=_dereq_("cached-constructors-x").Object("a");module.exports="a"===boxedString[0]&&0 in boxedString},{"cached-constructors-x":3}],5:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";var toBoolean=_dereq_("to-boolean-x");module.exports=function isFalsey(value){return!1===toBoolean(value)}},{"to-boolean-x":27}],10:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x"),INFINITY=_dereq_("infinity-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==INFINITY&&number!==-INFINITY}},{"infinity-x":7,"is-nan-x":12}],11:[function(_dereq_,module,exports){/**
 ...
 * @module nan-x
 */
"use strict";module.exports=NaN},{}],21:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":25,"to-string-x":34}],25:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var strSplit,isString;!1===_dereq_("has-boxed-string-x")&&(isString="function"==typeof(strSplit="".split)&&_dereq_("is-string")),module.exports=function splitIfBoxedBug(value){return isString&&isString(value)?strSplit.call(value,""):value}},{"has-boxed-string-x":4,"is-string":15}],27:[function(_dereq_,module,exports){/**
 ...
 * @module to-boolean-x
 */
"use strict";module.exports=function toBoolean(value){return!!value}},{}],28:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var libToInteger=_dereq_("to-integer-x"),toInteger2016=libToInteger.toInteger2016,toInteger2018=libToInteger.toInteger2018,MAX_SAFE_INTEGER=_dereq_("max-safe-integer"),$toLength2018=function toLength2018(value){var len=toInteger2018(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len};module.exports={toLength:$toLength2018,toLength2016:function toLength2016(value){var len=toInteger2016(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len},toLength2018:$toLength2018}},{"max-safe-integer":19,"to-integer-x":28}],30:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),castObject=_dereq_("cached-constructors-x").Object;module.exports=function toObject(value){return castObject(requireObjectCoercible(value))}},{"cached-constructors-x":3,"require-object-coercible-x":25}],32:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr={}.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":17,"validate.io-undefined":38}],34:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":16}],35:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":3,"require-coercible-to-string-x":24,"white-space-x":39}],37:[function(_dereq_,module,exports){/**
