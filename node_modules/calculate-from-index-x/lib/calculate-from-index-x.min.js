 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toLength=_dereq_("to-length-x").toLength2018,toInteger=_dereq_("to-integer-x").toInteger2018,isArrayLike=_dereq_("is-array-like-x"),getMax=function _getMax(a,b){return a>=b?a:b};module.exports=function calcFromIndex(array,fromIndex){var object=toObject(array);if(!1===isArrayLike(object))return 0;var index=toInteger(fromIndex);return index>=0?index:getMax(0,toLength(object.length)+index)}},{"is-array-like-x":7,"to-integer-x":29,"to-length-x":30,"to-object-x":32}],2:[function(_dereq_,module,exports){/**
 ...
 * @module infinity-x
 */
"use strict";module.exports=1/0},{}],7:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";var toBoolean=_dereq_("to-boolean-x");module.exports=function isFalsey(value){return!1===toBoolean(value)}},{"to-boolean-x":28}],10:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x"),INFINITY=_dereq_("infinity-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==INFINITY&&number!==-INFINITY}},{"infinity-x":6,"is-nan-x":14}],11:[function(_dereq_,module,exports){/**
 ...
 * @module is-integer-x
 */
"use strict";var numberIsFinite=_dereq_("is-finite-x"),toInteger=_dereq_("to-integer-x").toInteger2018;module.exports=function isInteger(value){return numberIsFinite(value)&&toInteger(value)===value}},{"is-finite-x":10,"to-integer-x":29}],13:[function(_dereq_,module,exports){/**
 ...
 * @module is-length-x
 */
"use strict";var isSafeInteger=_dereq_("is-safe-integer-x");module.exports=function isLength(value){return isSafeInteger(value)&&value>=0}},{"is-safe-integer-x":17}],14:[function(_dereq_,module,exports){/**
 ...
 * @module nan-x
 */
"use strict";module.exports=NaN},{}],23:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":27,"to-string-x":35}],27:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":15}],28:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var libToInteger=_dereq_("to-integer-x"),toInteger2016=libToInteger.toInteger2016,toInteger2018=libToInteger.toInteger2018,MAX_SAFE_INTEGER=_dereq_("max-safe-integer"),$toLength2018=function toLength2018(value){var len=toInteger2018(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len};module.exports={toLength:$toLength2018,toLength2016:function toLength2016(value){var len=toInteger2016(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len},toLength2018:$toLength2018}},{"max-safe-integer":21,"to-integer-x":29}],31:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),castObject=_dereq_("cached-constructors-x").Object;module.exports=function toObject(value){return castObject(requireObjectCoercible(value))}},{"cached-constructors-x":3,"require-object-coercible-x":27}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr={}.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":19,"validate.io-undefined":39}],35:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":18}],36:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":3,"require-coercible-to-string-x":26,"white-space-x":40}],38:[function(_dereq_,module,exports){/**
