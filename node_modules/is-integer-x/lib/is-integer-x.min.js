 ...
 * @module is-integer-x
 */
"use strict";var numberIsFinite=_dereq_("is-finite-x"),toInteger=_dereq_("to-integer-x").toInteger2018;module.exports=function isInteger(value){return numberIsFinite(value)&&toInteger(value)===value}},{"is-finite-x":9,"to-integer-x":24}],2:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";var toBoolean=_dereq_("to-boolean-x");module.exports=function isFalsey(value){return!1===toBoolean(value)}},{"to-boolean-x":23}],9:[function(_dereq_,module,exports){/**
 ...
 * @module nan-x
 */
"use strict";module.exports=NaN},{}],18:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":22,"to-string-x":28}],22:[function(_dereq_,module,exports){/**
 ...
 * @module to-boolean-x
 */
"use strict";module.exports=function toBoolean(value){return!!value}},{}],24:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":14}],29:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":3,"require-coercible-to-string-x":21,"white-space-x":33}],31:[function(_dereq_,module,exports){/**
